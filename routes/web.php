...
Route::get('/historico/gastos', [HistoryController::class, 'expenses'])->name('historico.gastos');
Route::get('/historico/ganhos', [HistoryController::class, 'index'])->name('historico.ganhos');
